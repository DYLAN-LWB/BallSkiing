    ...
    private setupSubViews() {
        ...
        if (parseInt(this._info._isfrom) == 0) {
            ...
            introduce.textFlow = <Array<egret.ITextElement>>[
                { text: "轻按屏幕下方，控制倍倍上升，使其成功吃到汉字并组成成语，碰到障碍物即游戏结束（吃到魔法棒可重新记录成语哦~）根据最高分排名，排名前50都有红包奖励！此外，我们还会随机抽取100名发送幸运红包。每人共有5次挑战机会，",
            ...
            introduce.text = "轻按屏幕下方，控制倍倍上升，使其成功吃到汉字并组成成语，碰到障碍物即游戏结束（吃到魔法棒可重新记录成语哦~）";
